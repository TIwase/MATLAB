...
path = 'C:\Users\TakuyaIwase\Documents\MATLAB\Git\MATLAB\CEC&GECCO_2019\codes\';
addpath([path 'CallDataBases\'],[path 'Functions\']) 
...
noRuns=3; %Set this value to 20 for competition results
ResDB=struc([]);
